...
if [[ $1 = cross ]] ; then
  ...
  cmake -S . -B build-win32 -D CMAKE_TOOLCHAIN_FILE=CMake/i686-w64-mingw32.cmake -D MyGen_DIR=build
  cmake --build build-win32

  # build using 64-bit MinGW-w64 GCC cross-compiler
  cmake -S . -B build-win64 -D CMAKE_TOOLCHAIN_FILE=CMake/x86_64-w64-mingw32.cmake -D MyGen_DIR=build
